...
%}
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Position = [2 301 274 118];
            app.WelcomeTitle.Text = 'Welcome to Regression Basics';
            ...
            app.Image.ImageSource = 'Images/RegressionBasics.png';
            ...
            app.ReviewTitle.Position = [2 301 274 118];
            app.ReviewTitle.Text = 'Welcome to Regression Basics';
